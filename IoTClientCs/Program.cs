...
namespace IoTClientCs
{
    class Program
    {
        static void Main(string[] _)
        {
            ...
            object obj;
            int hr = Ole32.CoCreateInstance(Contract.Constants.IoTAgentClassGuid, IntPtr.Zero, Ole32.CLSCTX_LOCAL_SERVER, typeof(IoTServer.Contract.IIoTAgent).GUID, out obj);
            if (hr < 0) {
