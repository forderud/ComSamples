...
/** Minimal COM class factory implementation.
    TODO: Replace with wil::detail::CppWinRTClassFactory after https://github.com/microsoft/wil/pull/537 and https://github.com/microsoft/wil/issues/534 are resolved. */
template <class T>
