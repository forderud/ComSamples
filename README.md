...
STA threads need to manually pump messages to process incoming calls - just like GUI application does to process mouse & keyboard events. The implementation then need to take into account that reentrancy can occur as part of the message pumping.
