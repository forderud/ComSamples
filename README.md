...
* COM is **in-built in Windows**. There's no need to install any additional "runtime" or "brokers".. COM is used for GPU programming with Direct3D, HW diagnsotis with WMI and most new Windows features are exposed through COM-based [WinRT](https://en.wikipedia.org/wiki/Windows_Runtime) interfaces.
