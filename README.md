...
* **Long-term stable binary API** (ABI) that has been available since 1993. Allows interoperability with COM servers compiled more than 20 years ago without having to rebuild them.
